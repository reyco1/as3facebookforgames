...
<ol>
    ...
    <li><strong>ShareManager</strong> - Allows you to post the the users wall or open a share link popup.</li>
	<li><strong>ScoreManager</strong> - Allows you to get the scores for the game, for the user and the user's frinds. Also allows you to save the user's score.</li>
